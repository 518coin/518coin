// Copyright (c) 2014 The 518Coin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("518coin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("518coin-smsg-pow"); // Make this thread recognisable
